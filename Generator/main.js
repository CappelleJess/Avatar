...
image_array = ['backhair1_blond', 'backhair1_ginger', 'backhair1_auburn', 'backhair1_chestnut', 'backhair1_black']
...
function get_random_image(){
	...
	document.getElementById('backhair1_colour').src = "./items/backhair/${selected_image}"
}
